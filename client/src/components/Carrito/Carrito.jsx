      ...
      <div className="row justify-content-center">
        <div className="col-12">
          <button
            onClick={() => cerrarReg()}
            type="button"
            className="btn-close bg-danger text-light"
            aria-label="Close"
          ></button>
          <h5>
            Productos: ({totalUniqueItems}) Total items: ({totalItems})
          </h5>
            ...
            {items.map((e) => {
              return (
                <tr>
                  ...
                  <td>{e.name}</td> <td className="fw-bold">$ {e.price}</td>{" "}
        ...
        <div className="col-auto">
          <button
            ...
            onClick={() => {
              paymentMP(items, user, navigate, emptyCart);
            }}
          >
            Comprar Ahora
          </button>
